  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        'https://script.google.com/macros/s/AKfycbysG6Qllt26e2lsfb9XWaDopPIqJ7rrqa0Lio04BCO_fEdeag6w-xaaVGlJ2OY4qGgL3g/exec',
        {
          method: 'POST',
          body: form,
        }
          ...
          <div className="contact-info slide-up">
            <div className="info-card">
              ...
              <div className="info-text">
                ...
                <p>Plot No-1367/3053, Khata No-644/1188, Laxmisagar (khorda), Khorda, Bhubaneswar, Orissa, India, 751006</p>
              </div>
            </div>
